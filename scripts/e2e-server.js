...
const CasualFridayRotationGame = require('../src/core/models/CasualFridayRotationGame');
const CasualFridayPlaylist = require('../src/core/models/CasualFridayPlaylist');
const CasualFridayPlaylistEntry = require('../src/core/models/CasualFridayPlaylistEntry');
const ServerStatusSnapshot = require('../src/core/models/ServerStatusSnapshot');
const { nextFridayWindow } = require('../src/core/services/casualFridayService');
