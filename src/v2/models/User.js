...
userSchema.statics.normalizeUsername = (username) =>
  String(username || '')
    .trim()
...
userSchema.methods.toPublic = function toPublic() {
  return {
    ...
    steamAccount: this.steamAccount
      ? {
          steamId: this.steamAccount.steamId,
          linkedAt: this.steamAccount.linkedAt,
          lastSyncedAt: this.steamAccount.lastSyncedAt
        }
      : null,
