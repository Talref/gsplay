...
catalogueReassignmentSchema.index({
  sourceGameId: 1,
  provider: 1,
  providerGameId: 1,
  createdAt: -1
...
module.exports =
  mongoose.models.CatalogueReassignmentV2 ||
  mongoose.model('CatalogueReassignmentV2', catalogueReassignmentSchema);
