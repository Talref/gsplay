...
const canonicalGameSchema = new mongoose.Schema(
  {
    ...
    origin: {
      type: String,
      enum: ['provider_discovery', 'manual_catalogue', 'casual_friday'],
    ...
    fieldLocks: [
      {
        type: String,
        enum: ['canonicalTitle', 'summary', 'artwork', 'genres', 'platforms', 'releaseDate']
      }
    ],
    mergedIntoId: {
...
module.exports =
  mongoose.models.CanonicalGameV2 || mongoose.model('CanonicalGameV2', canonicalGameSchema);
